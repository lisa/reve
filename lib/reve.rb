...
module Reve
  ...
  class API
    ...
    @@alliances_url                = 'https://api.eveonline.com/eve/AllianceList.xml.aspx'
    @@sovereignty_url              = 'https://api.eveonline.com/map/Sovereignty.xml.aspx'
    @@reftypes_url                 = 'https://api.eveonline.com/eve/RefTypes.xml.aspx'
    @@skill_tree_url               = 'https://api.eveonline.com/eve/SkillTree.xml.aspx'
    @@member_tracking_url          = 'https://api.eveonline.com/corp/MemberTracking.xml.aspx'
    @@corporate_wallet_balance_url = 'https://api.eveonline.com/corp/AccountBalance.xml.aspx'
    @@personal_wallet_balance_url  = 'https://api.eveonline.com/char/AccountBalance.xml.aspx'
    @@corporate_wallet_trans_url   = 'https://api.eveonline.com/corp/WalletTransactions.xml.aspx'
    @@personal_wallet_trans_url    = 'https://api.eveonline.com/char/WalletTransactions.xml.aspx'
    @@corporate_wallet_journal_url = 'https://api.eveonline.com/corp/WalletJournal.xml.aspx'
    @@personal_wallet_journal_url  = 'https://api.eveonline.com/char/WalletJournal.xml.aspx'
    @@characters_url               = 'https://api.eveonline.com/account/Characters.xml.aspx'
    @@training_skill_url           = 'https://api.eveonline.com/char/SkillInTraining.xml.aspx'
    @@skill_queue_url              = 'https://api.eveonline.com/char/SkillQueue.xml.aspx'
    @@character_sheet_url          = 'https://api.eveonline.com/char/CharacterSheet.xml.aspx'
    @@starbases_url                = 'https://api.eveonline.com/corp/StarbaseList.xml.aspx'
    @@starbasedetail_url           = 'https://api.eveonline.com/corp/StarbaseDetail.xml.aspx'
    @@conqurable_outposts_url      = 'https://api.eveonline.com/eve/ConquerableStationList.xml.aspx'
    @@corporation_sheet_url        = 'https://api.eveonline.com/corp/CorporationSheet.xml.aspx'
    @@corporation_member_security_url = 'https://api.eveonline.com/corp/MemberSecurity.xml.aspx'
    @@errors_url                   = 'https://api.eveonline.com/eve/ErrorList.xml.aspx'
    @@map_jumps_url                = 'https://api.eveonline.com/map/Jumps.xml.aspx'
    @@map_kills_url                = 'https://api.eveonline.com/map/Kills.xml.aspx'
    @@personal_market_orders_url   = 'https://api.eveonline.com/char/MarketOrders.xml.aspx'
    @@corporate_market_orders_url  = 'https://api.eveonline.com/corp/MarketOrders.xml.aspx'
    @@personal_industry_jobs_url   = 'https://api.eveonline.com/char/IndustryJobs.xml.aspx'
    @@corporate_industry_jobs_url  = 'https://api.eveonline.com/corp/IndustryJobs.xml.aspx'
    @@personal_assets_url          = 'https://api.eveonline.com/char/AssetList.xml.aspx'
    @@corporate_assets_url         = 'https://api.eveonline.com/corp/AssetList.xml.aspx'
    @@personal_kills_url           = 'https://api.eveonline.com/char/KillLog.xml.aspx'
    @@corporate_kills_url          = 'https://api.eveonline.com/corp/KillLog.xml.aspx'
    @@character_id_url             = 'https://api.eveonline.com/eve/CharacterID.xml.aspx'   # ?names=CCP%20Garthagk
    @@character_name_url           = 'https://api.eveonline.com/eve/CharacterName.xml.aspx' # ?ids=797400947
    @@personal_faction_war_stats_url= 'https://api.eveonline.com/char/FacWarStats.xml.aspx'
    @@corporate_faction_war_stats_url= 'https://api.eveonline.com/corp/FacWarStats.xml.aspx'
    @@general_faction_war_stats_url= 'https://api.eveonline.com/eve/FacWarStats.xml.aspx'
    @@top_faction_war_stats_url    = 'https://api.eveonline.com/eve/FacWarTopStats.xml.aspx'
    @@faction_war_occupancy_url    = 'https://api.eveonline.com/map/FacWarSystems.xml.aspx'
    @@certificate_tree_url         = 'https://api.eveonline.com/eve/CertificateTree.xml.aspx'
    @@character_medals_url         = 'https://api.eveonline.com/char/Medals.xml.aspx'
    @@corporate_medals_url         = 'https://api.eveonline.com/corp/Medals.xml.aspx'
    @@corp_member_medals_url       = 'https://api.eveonline.com/corp/MemberMedals.xml.aspx'
    @@server_status_url            = 'https://api.eveonline.com/Server/ServerStatus.xml.aspx'
    @@research_url                 = 'https://api.eveonline.com/char/Research.xml.aspx'
    @@personal_notification_url    = 'https://api.eveonline.com/char/Notifications.xml.aspx'
    @@personal_mailing_lists_url   = 'https://api.eveonline.com/char/mailinglists.xml.aspx'
    @@personal_mail_messages_url   = 'https://api.eveonline.com/char/MailMessages.xml.aspx'
    @@personal_contacts_url        = 'https://api.eveonline.com/char/ContactList.xml.aspx'
    @@corporate_contacts_url       = 'https://api.eveonline.com/corp/ContactList.xml.aspx'
    @@account_status_url           = 'https://api.eveonline.com/account/AccountStatus.xml.aspx'
    @@character_info_url           = 'https://api.eveonline.com/eve/CharacterInfo.xml.aspx'
